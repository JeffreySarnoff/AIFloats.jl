...
using AIFloats:
    ...
    nmagnitudes_sig_nonzero, nmagnitudes_subnormal, normal_exp_stride, magnitude_normal_steps, nvalues,
    ...
    magnitude_prenormal_steps, magnitude_significand_seq, two, two_pow, typeforcode, typeforfloat,

...
using AIFloats:
    ...
    nbits, n_exp_bits, n_frac_bits, n_sig_bits, n_sign_bits, nmags, nmags_finite,
    ...
    nmags_sig_nonzero, nmags_subnormal, normal_exp_stride, normal_mag_steps, n_values,
    n_values_exp, n_values_exp_nonzero, n_finite_nums, n_finite_nums_negative,
    n_finite_nums_nonneg, n_nonzero_finite_nums, n_finite_nums_positive, n_values_negative,
    n_values_nonneg, n_values_normal, n_values_normal_extended, n_nums,
    n_nonzero_nums, n_values_positive, n_values_prenormal, n_values_subnormal, pow2_foundation_exps,

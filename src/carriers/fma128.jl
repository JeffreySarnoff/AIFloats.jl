# PROVENANCE: adapted from SmallFloats.jl `src/fma128.jl`
#   repo   ~/github/SmallFloats.jl (unregistered)
#   commit 7f864f08dbe8a31de60d0b4e9a1d826871186bd2 (2026-08-27)
#   port   2026-08-28 — copied for AIFloats; ALGORITHM UNCHANGED. The module
#          keeps its original name and is loaded as a submodule of AIFloats.
#          The Windows `__init__` hook that installs `Base.fma` is retained.
#   gate   test/test-dyadic.jl compares fma128 against Base's libquadmath
#          binding (where available) and an exact BigFloat reference.
#
# Float128FMA.jl
#
